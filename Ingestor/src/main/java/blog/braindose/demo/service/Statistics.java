...
public class Statistics {
    ...
    public String echo(){
        ...
        return "Throughput: " + df1.format(totalRecord/seconds) + ", Total Duration: " + df2.format(timeValue) + " " + timeLabel + ", Total Size: " + df2.format(sizeValue) + " " + sizeLabel + ", Total File: " + totalFile + ", Total Record: " + totalRecord;
    }
